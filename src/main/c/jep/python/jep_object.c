 ...
 */
JNIEXPORT jobject JNICALL Java_com_dropchop_snakejar_embed_python_PyObject_getAttr
 ...
 */
JNIEXPORT void JNICALL Java_com_dropchop_snakejar_embed_python_PyObject_setAttr
 ...
 */
JNIEXPORT void JNICALL Java_com_dropchop_snakejar_embed_python_PyObject_delAttr
(JNIEnv *env, jobject obj, jlong tstate, jlong pyobj, jstring str)
{
    JepThread  *jepThread;
    PyObject   *pyObject;
 ...
 */
JNIEXPORT jboolean JNICALL Java_com_dropchop_snakejar_embed_python_PyObject_equals
 ...
 */
JNIEXPORT jstring JNICALL Java_com_dropchop_snakejar_embed_python_PyObject_toString
 ...
 * Signature: (JJ)J
 */
JNIEXPORT jlong JNICALL Java_com_dropchop_snakejar_embed_python_PyObject_hashCode
(JNIEnv *env, jobject obj, jlong tstate, jlong pyobj)
{
    JepThread  *jepThread;
    PyObject   *pyObject;
 ...
 */
JNIEXPORT jobject JNICALL Java_com_dropchop_snakejar_embed_python_PyObject_as
