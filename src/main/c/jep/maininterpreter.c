 ...
 * Signature: (IIIIIII)V
 */
JNIEXPORT void JNICALL Java_com_dropchop_snakejar_embed_MainInterpreter_setInitParams
(JNIEnv *env,
 jclass class,
 jint noSiteFlag,
 ...
 */
JNIEXPORT void JNICALL Java_com_dropchop_snakejar_embed_MainInterpreter_initializePython
 ...
 * Signature: (Ljava/lang/String;)V
 */
JNIEXPORT void JNICALL Java_com_dropchop_snakejar_embed_MainInterpreter_sharedImportInternal
