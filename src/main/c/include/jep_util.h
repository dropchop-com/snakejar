...
#define CLASS_TABLE(F) \
    ...
    F(JEP_PROXY_TYPE, "com/dropchop/snakejar/embed/Proxy") \
    ...
    F(JEP_EXC_TYPE, "com/dropchop/snakejar/embed/JepException") \
    F(JPYOBJECT_TYPE, "com/dropchop/snakejar/embed/python/PyObject") \
    F(JPYCALLABLE_TYPE, "com/dropchop/snakejar/embed/python/PyCallable") \
    NUMPY_CLASS_TABLE(F)

#if JEP_NUMPY_ENABLED
#define NUMPY_CLASS_TABLE(F) \
    F(JEP_NDARRAY_TYPE, "com/dropchop/snakejar/embed/NDArray") \
    F(JEP_DNDARRAY_TYPE, "com/dropchop/snakejar/embed/DirectNDArray")
#else
#define NUMPY_CLASS_TABLE(F)
#endif
